<template>
    ...
    <form v-on:submit.prevent="Register">
        ...
        <input type="text" id="rut" class="fadeIn second" minlength="9" maxlength="9" required name="rut" v-model="usuario.rut" >
        ...
        <div class="alert alter-danger" role="alert" v-if="error3">
        ...
        <div class="alert alter-danger" role="alert" v-if="error4">
